...
from .schweizmobil_subs_sale_subscription_renewal import (
    pre as pre_schweizmobil_subs_sale_subscription_renewal,
)
...
def pre(ctx):
    ...
    pre_schweizmobil_subs_sale_subscription_renewal(ctx)
